...
// processes to communicate with and and manage the lifetime of a ndrd child
...
// message, shutdown begins.  This prevents ndrd from continuing to run
...
// for a child ndrd process to communicate with a parent process without the
