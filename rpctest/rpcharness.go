...
// Harness fully encapsulates an active ndrd process, along with an embedded
// dcrwallet to provide a unified platform for creating RPC-driven integration
// tests involving ndrd. The active ndrd node will typically be run in simnet
...
// spends. The active ndrd process is fully managed by Harness, which handles
...
// ndrd process belonging to this Harness instance. If the initial connection
